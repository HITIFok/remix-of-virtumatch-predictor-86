...
export function useLiveMatches() {
  ...
  // ─── Note: auto-playout is now cron-only ───
  // Called by cron-job.org / Vercel Cron (requires CRON_SECRET).
  // Frontend must NOT call it directly — would get 401 Unauthorized.
