...
export const API_AUTH_MATRIX = Object.freeze([
  ...
  },
  {
    ...
    authFallback: 'request/verify/latest-apk are public; refresh-token & delete-account require User Bearer',
    rateLimited: true,
    ...
    isPublic: true,
    riskLevel: 'LOW',
    notes: 'Email enumeration protection; magic links are single-use, 15-min expiry; refresh-token action rotates Bearer token; delete-account action performs GDPR Art.17 cascade deletion',
  },
  {
