...
DATABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd4bW1lZW16a2l4aW5zeGdsZmFxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzM0MDUzNTUsImV4cCI6MjA4ODk4MTM1NX0.5MEMH8RS6HX3CJfAJATilNlz_hVrBeOdSjeur-wmr9E"
...
def save_to_supabase(data):
    ...
    if data.get("matches"):
        resp = requests.post(
            f"{DATABASE_URL}/rest/v1/scraped_data?onConflict=data_type,league",
            json={
                "data_type": "matches",
                "league": "Instant League",
            ...
            headers={
                ...
                "Authorization": f"Bearer {DATABASE_ANON_KEY}",
